 ...
 */
public class AddFragment extends Fragment implements AddMahasiswaAsync.AddMahasiswaCallback{
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new AddMahasiswaAsync(getActivity(),AddFragment.this,m).execute();
    ...
    public void postexecute() {
        Toast.makeText(getActivity(), "Add Mahasiswa sukses", Toast.LENGTH_SHORT).show();
    }
...
class AddMahasiswaAsync {
    private final WeakReference<Context> weakContext;
    private final WeakReference<AddMahasiswaCallback> weakAddMahasiswaCallback;
    private Mahasiswa mhs;
    AddMahasiswaAsync(Context weakContext, AddMahasiswaCallback weakAddMahasiswaCallback, Mahasiswa mhs) {
        this.weakContext = new WeakReference<>(weakContext) ;
        this.weakAddMahasiswaCallback = new WeakReference<>(weakAddMahasiswaCallback) ;
        this.mhs = mhs;
    }
    void execute(){
        ExecutorService executorService = Executors.newSingleThreadExecutor();
        Handler handler = new Handler(Looper.getMainLooper());
        weakAddMahasiswaCallback.get().preexecute();
        executorService.execute(()->{
            Context c = weakContext.get();
            AppDatabase.getAppDatabase(c).mahasiswaDAO().insert(mhs);
            handler.post(()->weakAddMahasiswaCallback.get().postexecute());
        });
    }

    interface  AddMahasiswaCallback {
        void preexecute();
        void postexecute();
    }
